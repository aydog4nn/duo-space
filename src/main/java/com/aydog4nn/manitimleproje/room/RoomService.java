...
public class RoomService {
    ...
    public RoomResponse get(UUID roomId) { return toResponse(findRoom(roomId)); }
    public List<RoomResponse> listByOwner(UUID ownerId) { return roomRepository.findByOwner_Id(ownerId).stream().map(this::toResponse).toList(); }
    ...
    @Transactional
    public void delete(UUID roomId) { roomRepository.delete(findRoom(roomId)); }
